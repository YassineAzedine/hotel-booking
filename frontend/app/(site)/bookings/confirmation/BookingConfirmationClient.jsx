    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-indigo-100 flex items-center justify-center px-4">
      <div className="bg-white shadow-2xl rounded-3xl max-w-xl w-full p-10 space-y-6 border border-indigo-100">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-extrabold text-indigo-700">Réservation Confirmée</h1>
        ...
        <div className="bg-indigo-50 rounded-xl p-6 space-y-3 text-sm text-gray-800">
          <p>
            <span className="font-semibold">🛏 Chambre :</span> {room ?? 'Non spécifiée'}
          </p>
          <p>
            <span className="font-semibold">📅 Arrivée :</span> {arrival ?? 'Non spécifiée'}
          </p>
          <p>
            <span className="font-semibold">📅 Départ :</span> {departure ?? 'Non spécifiée'}
          </p>
          <p>
            <span className="font-semibold">👤 Nom complet :</span> {fullName ?? 'Non spécifié'}
          </p>
          <p>
            <span className="font-semibold">📞 Téléphone :</span> {phone ?? 'Non spécifié'}
          </p>
        </div>
